...
namespace HuaweiUnlocker.TOOLS
{
    public class UpgradeMode
    {
        ...
        [DllImport("hwbc.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int ConnectPhone(out int i);

        [DllImport("hwbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern int GetAuthorizationData(int i, out int ai);

        [DllImport("hwbc.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int AuthorizePhone(char[] a, int ga, UInt32 asf, int i);

        [DllImport("hwbc.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int WriteQualcommBootloaderCode(char[] a, int ga, UInt32 asf, int i);

        [DllImport("hwbc.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int UnlockBootloader(out int i);
